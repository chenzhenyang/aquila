 ...
 *
 */
public class MigrateConstraintUKFunction extends AquilaFunction {

	@SuppressWarnings("static-access")
	public MigrateConstraintUKFunction() {
		this.addOption(OptionBuilder.withDescription("migrate Forgein Constraint.").withLongOpt("name").hasArg().create("name"));
	}
