 ...
 *
 */
public class MigrateConstraintCKFunction extends AquilaFunction {

	@SuppressWarnings("static-access")
	public MigrateConstraintCKFunction() {
		this.addOption(OptionBuilder.withDescription("migrate Check Constraint.").withLongOpt("name").hasArg().create("name"));
	}
	...
	private void migrateCheckConstraint(String constrName) throws IOException, SQLException, InterruptedException {
		...
		MigrateConstraint.createConstraintCK(constrName);
