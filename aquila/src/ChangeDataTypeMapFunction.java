 ...
 *
 */
public class ChangeDataTypeMapFunction extends AquilaFunction {
	@SuppressWarnings("static-access")
	public ChangeDataTypeMapFunction() {
		this.addOption(OptionBuilder.withDescription("change a data type map.").withLongOpt("s").hasArg().create("s"));
		this.addOption(OptionBuilder.withDescription("change a data type map.").withLongOpt("d").hasArg().create("d"));
	}
